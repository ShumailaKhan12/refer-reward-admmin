                                ...
                                <div className='col-lg-5'>
                                    <div className='bg-light-white-color p-4 border-radius-16'>
                                        ...
                                        <div className='d-flex align-items-center justify-content-between'>
                                            <div>
                                                <p className='font-18 montserrat-semibold text-border-gray-color mb-0 mt-3'>Exclusive Offers</p>
                                                    ...
                                                    {products.map((item, index) => (
                                                        <div className="product-card rounded-3" key={index}>
                                                            <div className='product-card-header d-flex justify-content-between align-items-center rounded-top pb-3'>
                                                                ...
                                                                <div className='product-edit d-flex justify-content-center align-items-center width-32 height-32'>
                                                                    <PiPencilSimple className='font-20 text-blue-color' />
                                                                </div>
                                                            </div>
                                                            <div className='p-3'>
